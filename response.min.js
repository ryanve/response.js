/*! response.js 0.7.13 | responsejs.com | MIT License 2014 Ryan Van Etten */
...
b[d]||(b[d]=function(b,c){return a(t(this,function(a){return!!a&&!c===k[d](a,b)}))})})}function ja(a,b){if("function"==typeof a&&a.fn){if(b||void 0===a.fn.dataset)a.fn.dataset=F;if(b||void 0===a.fn.deletes)a.fn.deletes=ca;wa(a,a.fn,b)}return k}if("function"!=typeof f)try{return void console.warn("response.js aborted due to missing dependency")}catch(Da){}var k,L=this,r="Response",xa=L[r],ka="init"+r,n=window,la=document,u=la.documentElement,K=f.domReady||f,y=f(n),A=n.screen,m=Array.prototype,B=Object.prototype,
