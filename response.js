...
(function( window ) {// this === window in the global scope
    var createResponse = function(jQuery) {
        ...
        var Response
          ...
          , $ = jQuery || window.jQuery || window.Zepto || window.ender
          , ready = $.domReady || $
    ...
    if (typeof define === "function" && define.amd) {
        define(['jquery'], function(jQuery) {
            return createResponse(jQuery);
        });
    } else {
        window.Response = createResponse();
    }
}( this )); // Watch @link vimeo.com/12529436
